...
- [ClickHouse/clickhouse-cpp](https://github.com/ClickHouse/clickhouse-cpp) (★320 C) - ClickHouse/clickhouse-cpp is a C++ client library designed for seamless interaction with the ClickHouse database.
- [RoaringBitmap/CRoaring](https://github.com/RoaringBitmap/CRoaring) (★1626 C) - CRoaring is a library that implements Roaring bitmaps in C and C++, optimized for high performance with SIMD enhancements.
...
- [simdjson/simdjson](https://github.com/simdjson/simdjson) (★20030 C++) - simdjson is a high-performance JSON parsing library that achieves gigabytes of parsing speed per second.
...
- [AfterShip/clickhouse-sql-parser](https://github.com/AfterShip/clickhouse-sql-parser) (★168 Go) - A Go library and CLI tool for parsing ClickHouse SQL into an Abstract Syntax Tree (AST) and beautifying SQL format.
- [ClickHouse/ch-go](https://github.com/ClickHouse/ch-go) (★346 Go) - A low-level TCP client for the ClickHouse database implemented in Go.
- [ClickHouse/clickhouse-go](https://github.com/ClickHouse/clickhouse-go) (★3030 Go) - This project is a Golang driver for ClickHouse, providing a way to interact with ClickHouse databases.
...
- [flexprice/flexprice](https://github.com/flexprice/flexprice) (★182 Go) - Flexprice offers open-source pricing and billing infrastructure for flexible, developer-friendly implementations in AI-driven businesses.
...
- [runreveal/pql](https://github.com/runreveal/pql) (★650 Go) - PQL is a Go library that compiles a pipelined-based query language into SQL, primarily tested with Clickhouse.
...
- [transferia/transferia](https://github.com/transferia/transferia) (★107 Go) - Transferia is an open-source cloud-native ingestion engine that simplifies data transfer across various platforms, supporting high-performance data pipelines.
...
- [ClickHouse/metabase-clickhouse-driver](https://github.com/ClickHouse/metabase-clickhouse-driver) (★508 Clojure) - This project is a ClickHouse database driver designed for integration with the Metabase business intelligence frontend.
...
- [DotNetNext/SqlSugar](https://github.com/DotNetNext/SqlSugar) (★5526 C#) - SqlSugar is a user-friendly ORM framework for .NET that facilitates database interactions with minimal code.
...
- [smi2/phpClickHouse](https://github.com/smi2/phpClickHouse) (★774 PHP) - A PHP wrapper for the ClickHouse database that allows for asynchronous queries and bulk data insertion.
...
- [ClickHouse/clickhouse-connect](https://github.com/ClickHouse/clickhouse-connect) (★386 Python) - ClickHouse Connect is a Python driver that connects ClickHouse to Python, Pandas, and Superset.
...
- [cloudflare/sqlalchemy-clickhouse](https://github.com/cloudflare/sqlalchemy-clickhouse) (★318 Python) - This project provides a ClickHouse dialect for SQLAlchemy, allowing for seamless integration of ClickHouse and Python applications.
- [ibis-project/ibis](https://github.com/ibis-project/ibis) (★5677 Python) - Ibis is a portable Python dataframe library designed for efficient data manipulation and exploration.
...
- [mymarilyn/clickhouse-driver](https://github.com/mymarilyn/clickhouse-driver) (★1247 Python) - This project is a Python driver for ClickHouse that supports a native TCP interface.
- [tobymao/sqlglot](https://github.com/tobymao/sqlglot) (★7455 Python) - SQLGlot is a Python library that serves as a no-dependency SQL parser and transpiler supporting multiple SQL dialects.
- [xzkostyan/clickhouse-sqlalchemy](https://github.com/xzkostyan/clickhouse-sqlalchemy) (★463 Python) - ClickHouse dialect for SQLAlchemy.
...
- [ClickHouse/clickhouse-rs](https://github.com/ClickHouse/clickhouse-rs) (★371 Rust) - Official pure Rust typed client for ClickHouse DB.
...
- [langdb/ai-gateway](https://github.com/langdb/ai-gateway) (★555 Rust) - LangDB AI Gateway is an open-source project built in Rust to manage and optimize AI traffic across various LLMs using a unified OpenAI API interface.
...
- [linq2db/linq2db](https://github.com/linq2db/linq2db) (★3065 C#) - LINQ to DB is a fast LINQ database access library providing a lightweight, type-safe solution for database interactions.
...
- [ClickHouse/click-ui](https://github.com/ClickHouse/click-ui) (★88 TypeScript) - Click UI is a design system and component library for ClickHouse, aimed at providing UI components for application development.
- [CodePhiliaX/Chat2DB](https://github.com/CodePhiliaX/Chat2DB) (★22237 Java) - Chat2DB is an AI-driven database tool and SQL client that supports various database engines.
- [agnosticeng/agx](https://github.com/agnosticeng/agx) (★110 Svelte) - agx is a desktop application that enables users to explore and query data using Clickhouse through a modern interface.
- [caioricciuti/ch-ui](https://github.com/caioricciuti/ch-ui) (★333 TypeScript) - CH-UI is a user-friendly interface for managing data from ClickHouse databases.
- [iamtelescope/telescope](https://github.com/iamtelescope/telescope) (★547 Vue) - Telescope is a web-based log viewer designed to facilitate efficient exploration and analysis of log data stored in ClickHouse databases.
...
- [quarylabs/sqruff](https://github.com/quarylabs/sqruff) (★766 Rust) - Sqruff is a fast SQL linter and formatter written in Rust.
...
- [sqlchat/sqlchat](https://github.com/sqlchat/sqlchat) (★5081 TypeScript) - SQL Chat is a chat-based SQL client that allows users to interact with databases using natural language commands.
...
- [ClickHouse/clickpy](https://github.com/ClickHouse/clickpy) (★83 JavaScript) - ClickPy is a Python package analytics service powered by ClickHouse that provides insights into download statistics and package adoption.
- [FrigadeHQ/trench](https://github.com/FrigadeHQ/trench) (★1546 TypeScript) - Trench is an open-source analytics infrastructure designed for tracking events and providing real-time data analytics.
...
- [QuesmaOrg/quesma](https://github.com/QuesmaOrg/quesma) (★124 Go) - Quesma is a programmable database gateway that facilitates smooth migrations between different database platforms.
...
- [devlive-community/datacap](https://github.com/devlive-community/datacap) (★932 Java) - DataCap is an integrated software for data transformation, integration, and visualization.
...
- [growthbook/growthbook](https://github.com/growthbook/growthbook) (★6490 TypeScript) - GrowthBook is an open-source platform for feature flagging and A/B testing.
...
- [meteroid-oss/meteroid](https://github.com/meteroid-oss/meteroid) (★714 Rust) - Meteroid is an open-source billing infrastructure aimed at streamlining subscription management and invoicing for SaaS applications.
...
- [openblocks-dev/openblocks](https://github.com/openblocks-dev/openblocks) (★6004 TypeScript) - Openblocks is an open-source platform designed as an alternative to Retool for building internal applications and tools quickly.
- [openmeterio/openmeter](https://github.com/openmeterio/openmeter) (★1311 Go) - OpenMeter provides a cloud metering solution for AI and billing, facilitating real-time collection and aggregation of usage data.
- [plausible/analytics](https://github.com/plausible/analytics) (★22000 Elixir) - Plausible Analytics is a simple yet powerful open source web analytics tool that emphasizes privacy and easy usability.
...
- [somasays/pgwarehouse](https://github.com/somasays/pgwarehouse) (★81 Python) - pgwarehouse is a tool that enables easy synchronization of data from a Postgres database to cloud data warehouses like Snowflake and ClickHouse.
...
- [synmetrix/synmetrix](https://github.com/synmetrix/synmetrix) (★547 JavaScript) - Synmetrix is a production-ready open source semantic layer on Cube for managing metrics data.
- [timeplus-io/proton](https://github.com/timeplus-io/proton) (★1750 C++) - Timeplus Proton is a fast and lightweight streaming SQL engine powered by ClickHouse.
- [trickstercache/trickster](https://github.com/trickstercache/trickster) (★2019 Go) - Trickster is an open-source HTTP reverse proxy cache that enhances the performance of web applications and time series databases.
- [zerodha/dungbeetle](https://github.com/zerodha/dungbeetle) (★954 Go) - A distributed job server designed for queuing and executing heavy SQL read jobs asynchronously.
...
- [ClickHouse/kubenetmon](https://github.com/ClickHouse/kubenetmon) (★114 Go) - Kubenetmon is an open-source Kubernetes network metering solution developed by ClickHouse for monitoring network traffic in cloud environments.
- [burningalchemist/sql_exporter](https://github.com/burningalchemist/sql_exporter) (★386 Go) - The SQL Exporter is a configuration driven tool for exposing metrics from various DBMSs for Prometheus.
- [hyperdxio/hyperdx](https://github.com/hyperdxio/hyperdx) (★7721 TypeScript) - HyperDX is an open-source observability platform that aggregates logs, metrics, traces, exceptions, and session replays to quickly resolve production issues.
- [justwatchcom/sql_exporter](https://github.com/justwatchcom/sql_exporter) (★437 Go) - Flexible SQL Exporter for Prometheus that runs user-defined SQL queries and exports metrics for monitoring.
- [metrico/gigapipe](https://github.com/metrico/gigapipe) (★1383 Go) - Gigapipe is a lightweight, polyglot observability stack that integrates seamlessly with popular tools like ClickHouse, Loki, and Prometheus for logs, metrics, and traces.
...
- [openlit/openlit](https://github.com/openlit/openlit) (★1397 Python) - OpenLIT provides complete observability and evaluations for the entire GenAI stack, enabling developers to improve LLM applications from development to production.
...
- [uptrace/uptrace](https://github.com/uptrace/uptrace) (★3604 Go) - Uptrace is an open source APM that enables monitoring of application performance using OpenTelemetry traces, metrics, and logs.
...
- [Altinity/clickhouse-backup](https://github.com/Altinity/clickhouse-backup) (★1353 Go) - A tool for easy backup and restore for ClickHouse databases using object storage.
- [Altinity/clickhouse-operator](https://github.com/Altinity/clickhouse-operator) (★2063 Go) - Altinity Kubernetes Operator for ClickHouse manages ClickHouse clusters on Kubernetes.
...
- [ClickHouse/mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse) (★140 Python) - ClickHouse MCP Server is a multi-channel processing server for executing SQL queries and managing ClickHouse database clusters.
...
- [ContentSquare/chproxy](https://github.com/ContentSquare/chproxy) (★1331 Go) - Chproxy is an open-source HTTP proxy and load balancer for the ClickHouse database.
...
- [chdb-io/chdb](https://github.com/chdb-io/chdb) (★2313 C++) - chDB is an in-process SQL OLAP Engine powered by ClickHouse that allows efficient querying of data.
...
- [frectonz/sql-studio](https://github.com/frectonz/sql-studio) (★2602 Rust) - SQL Studio is a single command SQL database explorer that supports multiple databases including SQLite, PostgreSQL, and ClickHouse.
- [getlago/lago](https://github.com/getlago/lago) (★7533 Shell) - Lago is an open-source API for metering and usage-based billing.
...
- [jaegertracing/jaeger-clickhouse](https://github.com/jaegertracing/jaeger-clickhouse) (★261 Go) - Jaeger ClickHouse is a storage plugin implementation for storing traces within the ClickHouse database.
- [l1xnan/duckling](https://github.com/l1xnan/duckling) (★315 Rust) - Duckling is a fast viewer application for CSV and Parquet files and various databases, developed with Tauri.
...
- [myscale/MyScaleDB](https://github.com/myscale/MyScaleDB) (★948 C++) - MyScaleDB is an open-source SQL vector database built on ClickHouse for scalable AI application development.
...
- [tabixio/tabix](https://github.com/tabixio/tabix) (★2196 TypeScript) - Tabix is an open-source business intelligence application and SQL editor tool specifically tailored for Clickhouse.
...
- [ClickHouse/ClickHouse](https://github.com/ClickHouse/ClickHouse) (★40006 C++) - ClickHouse® is a real-time analytics DBMS that allows generating analytical data reports instantly.
- [ClickHouse/JSONBench](https://github.com/ClickHouse/JSONBench) (★124 HTML) - JSONBench is a benchmarking tool for data analytics on JSON across various databases.
...
- [ClickHouse/pastila](https://github.com/ClickHouse/pastila) (★71 HTML) - This project is a paste service built on top of ClickHouse, allowing users to share and store text data seamlessly.
- [PostHog/HouseWatch](https://github.com/PostHog/HouseWatch) (★560 TypeScript) - HouseWatch is an open-source tool for monitoring and managing ClickHouse clusters.
- [Slach/clickhouse-flamegraph](https://github.com/Slach/clickhouse-flamegraph) (★197 Go) - Clickhouse-flamegraph is a CLI utility for visualizing ClickHouse system.trace_log as flamegraphs.
- [Swetrix/swetrix](https://github.com/Swetrix/swetrix) (★428 TypeScript) - Swetrix is a cookie-less, open-source web analytics service that prioritizes user privacy.
...
- [akvorado/akvorado](https://github.com/akvorado/akvorado) (★1560 Go) - Akvorado is a flow collector, enricher, and visualizer that processes and displays network flow data.
...
- [clickvisual/clickvisual](https://github.com/clickvisual/clickvisual) (★1553 Go) - ClickVisual is a browser-based platform for log analytics and data visualization built on ClickHouse.
- [clidey/whodb](https://github.com/clidey/whodb) (★2991 TypeScript) - WhoDB is a lightweight database management tool with natural language query capabilities for multiple database types.
...
- [duyet/clickhouse-monitoring](https://github.com/duyet/clickhouse-monitoring) (★145 TypeScript) - A simple UI for monitoring ClickHouse using a dashboard built with Next.js.
...
- [timestored/qstudio](https://github.com/timestored/qstudio) (★698 Java) - qStudio is a free SQL analysis tool that enables users to browse tables, run SQL scripts, and visualize results.
...
- [ClickHouse/dbt-clickhouse](https://github.com/ClickHouse/dbt-clickhouse) (★277 Python) - The Clickhouse plugin for dbt (data build tool) enables data transformation functionalities integrated with ClickHouse.
- [PeerDB-io/peerdb](https://github.com/PeerDB-io/peerdb) (★2481 Go) - PeerDB is a fast and efficient ETL tool designed to replicate data from Postgres to various storage solutions.
...
- [amacneil/dbmate](https://github.com/amacneil/dbmate) (★5872 Go) - Dbmate is a lightweight and framework-agnostic tool designed for database migration.
- [apecloud/ape-dts](https://github.com/apecloud/ape-dts) (★416 Rust) - Ape Data Transfer Suite is a Rust-based tool enabling ultra-fast data replication between various databases ideal for migration and disaster recovery.
- [behnamyazdan/ecommerce_realtime_data_pipeline](https://github.com/behnamyazdan/ecommerce_realtime_data_pipeline) (★56 Python) - A project showcasing a real-time data pipeline for ecommerce data analysis using modern data engineering tools and techniques.
...
- [jitsucom/jitsu](https://github.com/jitsucom/jitsu) (★4268 TypeScript) - Jitsu is an open-source tool that acts as an alternative to Segment for collecting event data and streaming it to data warehouses.
...
- [nikepan/clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk) (★487 Go) - ClickHouse-Bulk is a tool for collecting and sending multiple small inserts to ClickHouse as larger batch inserts.
- [ozontech/file.d](https://github.com/ozontech/file.d) (★380 Go) - file.d is a fast and flexible tool for building data pipelines to efficiently read, process, and output events.
...
- [toddwschneider/nyc-taxi-data](https://github.com/toddwschneider/nyc-taxi-data) (★2021 R) - A project that provides scripts to process and analyze NYC taxi and for-hire vehicle trip data using PostgreSQL and ClickHouse.
...
- [wgzhao/Addax](https://github.com/wgzhao/Addax) (★1254 Java) - Addax is a versatile open-source ETL tool that can seamlessly transfer data between various RDBMS and NoSQL databases, making it an ideal solution for data migration.
- [ytsaurus/ytsaurus](https://github.com/ytsaurus/ytsaurus) (★2007 C++) - YTsaurus is a scalable and fault-tolerant open-source big data platform that facilitates distributed storage and processing.
- [zeromicro/cds](https://github.com/zeromicro/cds) (★970 Go) - ClickHouse Data Synchromesh is a Go-based tool designed for real-time data syncing from MySQL and MongoDB to ClickHouse.
...
- [ClickHouse/clickhouse-academy](https://github.com/ClickHouse/clickhouse-academy) (★69 Shell) - The ClickHouse Academy project provides training and certification materials for mastering ClickHouse databases.
...
- [ClickHouse/clickhouse-presentations](https://github.com/ClickHouse/clickhouse-presentations) (★1032 HTML) - This project provides presentations, meetups, and talks about ClickHouse, an open-source database management system.
...
- [centralmind/gateway](https://github.com/centralmind/gateway) (★224 Go) - CentralMind Gateway is an AI-first solution that automatically generates secure APIs for structured data, optimizing access for LLM applications while ensuring compliance and security.
- [dubinc/dub](https://github.com/dubinc/dub) (★21099 TypeScript) - Dub.co is an open-source link management infrastructure designed for modern marketing teams.
