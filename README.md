...
- [Language bindings](#language-bindings) 
    - [C++](#c++) (9)
    - [Elixir](#elixir) (4)
    - [JavaScript/Typescript](#javascripttypescript) (26)
    - [Golang](#golang) (34)
    - [Java](#java) (15)
    - [Kotlin](#kotlin) 
    - [.Net](#.net) (5)
...
- [UIs](#uis) 
    - [GUI](#gui) (2)
    - [CLI](#cli) (4)
    - [CHUI(Chat-based User Interface) or CHUBACA(Chat-Based Client:)](#chui(chat-based-user-interface)-or-chubaca(chat-based-client:)) (1)
...
- [ClickHouse/clickhouse-docs](https://github.com/ClickHouse/clickhouse-docs) - ClickHouse documentation repository providing resources and guidelines for effective use of the ClickHouse database.
- [ClickHouse/clickhouse-presentations](https://github.com/ClickHouse/clickhouse-presentations) - A repository of presentation materials for ClickHouse, an open-source column-oriented database management system.
...
- [ClickHouse/homebrew-clickhouse](https://github.com/ClickHouse/homebrew-clickhouse) - This is a deprecated Homebrew tap for ClickHouse, which is no longer maintained.
...
- [clickhouse-local](https://clickhouse.yandex/docs/en/operations/utils/clickhouse-local/) - ClickHouse Local is a utility for running ClickHouse queries and operations locally without a server.
...
- [ClickHouse/clickhouse-cpp](https://github.com/ClickHouse/clickhouse-cpp) - A C++ client library for connecting and interacting with ClickHouse databases.
...
- [balance-platform/pillar](https://github.com/balance-platform/pillar) - An Elixir client library for ClickHouse, enabling efficient database interactions with features like async inserts and migrations.
...
- [ClickHouse/clickhouse-js](https://github.com/ClickHouse/clickhouse-js) - A TypeScript client library for ClickHouse, supporting Node.js and web applications with streaming capabilities.
...
- [benawad/voidpulse](https://github.com/benawad/voidpulse) - An open-source analytics platform inspired by Mixpanel, enhanced with AI capabilities.
- [caioricciuti/ch-ui](https://github.com/caioricciuti/ch-ui) - A modern user interface for managing ClickHouse databases, built with React.
- [devlive-community/dbm](https://github.com/devlive-community/dbm) - A comprehensive database management tool supporting multiple SQL databases.
...
- [hyperdxio/hyperdx](https://github.com/hyperdxio/hyperdx) - HyperDX is an open-source observability platform that centralizes logs, metrics, traces, exceptions, and session replays to help engineers quickly resolve production issues.
- [inkeio/dbm](https://github.com/inkeio/dbm) - DBM is an open-source database management system built with TypeScript, supporting various SQL databases and offering features like query history and table management.
...
- [mlcraft-io/mlcraft](https://github.com/mlcraft-io/mlcraft) - Synmetrix is an open-source data engineering platform that provides a semantic layer for centralized metrics management, enabling flexible data modeling and integration.
...
- [tabixio/tabix](https://github.com/tabixio/tabix) - An open source business intelligence application and SQL editor tool for Clickhouse.
...
- [ClickHouse/clickhouse-go](https://github.com/ClickHouse/clickhouse-go) - A Golang SQL database client for ClickHouse that supports native protocol, connection pooling, and advanced query features.
...
- [amacneil/dbmate](https://github.com/amacneil/dbmate) - Dbmate is a versatile database migration tool written in Go that helps maintain database schema consistency across various development environments.
...
- [chdb-io/chdb-go](https://github.com/chdb-io/chdb-go) - Go bindings and CLI for chDB, an in-process SQL OLAP Engine powered by ClickHouse.
...
- [cloudflare/flow-pipeline](https://github.com/cloudflare/flow-pipeline) - A set of tools and examples for building a flow pipeline using GoFlow, a NetFlow/IPFIX/sFlow collector.
...
- [nikepan/clickhouse-bulk](https://github.com/nikepan/clickhouse-bulk) - ClickHouse-Bulk is a Go library that collects and sends insert requests to ClickHouse servers efficiently.
...
- [springrain/zorm](https://github.com/springrain/zorm) - A lightweight ORM library for Go that supports multiple databases including MySQL, PostgreSQL, Oracle, and more.
...
- [ClickHouse/clickhouse-jdbc-bridge](https://github.com/ClickHouse/clickhouse-jdbc-bridge) - A JDBC bridge for ClickHouse that allows executing distributed queries across multiple external data sources.
...
- [DarkWanderer/ClickHouse.Client](https://github.com/DarkWanderer/ClickHouse.Client) - A high-performance ADO.NET client for ClickHouse, designed for efficient interaction with a big data relational database.
...
- [aws-samples/aws-lambda-clickhouse](https://github.com/aws-samples/aws-lambda-clickhouse) - This project demonstrates how to run ClickHouse, an open-source online analytics database, in an AWS Lambda function for serverless data querying.
- [grafana/clickhouse-datasource](https://github.com/grafana/clickhouse-datasource) - A Grafana plugin that enables querying and visualizing ClickHouse data.
...
- [droher/boxball](https://github.com/droher/boxball) - Boxball is a Python project that creates prepopulated databases from major open source baseball datasets, utilizing Docker and SQLAlchemy for efficient data management.
...
- [long2ice/synch](https://github.com/long2ice/synch) - A Python tool for syncing data from MySQL and PostgreSQL to ClickHouse with support for full and incremental ETL.
- [maximdanilchenko/aiochclient](https://github.com/maximdanilchenko/aiochclient) - aiochclient is an asynchronous HTTP(S) client for ClickHouse, designed for Python 3.6 and above, offering type conversion, streaming, and lazy decoding.
...
- [mymarilyn/clickhouse-driver](https://github.com/mymarilyn/clickhouse-driver) - A Python driver for ClickHouse that supports native TCP interface and adheres to DB API 2.0.
...
- [scottpersinger/pgwarehouse](https://github.com/scottpersinger/pgwarehouse) - A Python package for efficiently syncing data from Postgres to cloud data warehouses like Snowflake, ClickHouse, or DuckDB.
...
- [PNixx/clickhouse-activerecord](https://github.com/PNixx/clickhouse-activerecord) - A Ruby ActiveRecord driver for ClickHouse, enabling seamless integration with Rails applications.
...
- [ClickHouse/clickhouse-rs](https://github.com/ClickHouse/clickhouse-rs) - A pure Rust client library for ClickHouse DB that provides typed access and various features for database interaction.
...
- [azat/chdig](https://github.com/azat/chdig) - A TUI interface for exploring and monitoring ClickHouse databases.
...
- [subzerocloud/subzero](https://github.com/subzerocloud/subzero) - subZero is a Rust library that simplifies building REST APIs and backend services, supporting multiple flavors and databases.
...
- [ClickHouse/spark-clickhouse-connector](https://github.com/ClickHouse/spark-clickhouse-connector) - A Scala library that provides a connector for integrating ClickHouse with Apache Spark using the DataSourceV2 API.
...
- [frectonz/sql-studio](https://github.com/frectonz/sql-studio) - A command line tool for exploring various SQL databases including SQLite, libSQL, PostgreSQL, MySQL, and DuckDB.
- [hatarist/clickhouse-cli](https://github.com/hatarist/clickhouse-cli) - A command-line client for ClickHouse DBMS with features like autocompletion, syntax highlighting, and custom commands.
...
- [Altinity/clickhouse-backup](https://github.com/Altinity/clickhouse-backup) - A utility for easy backup and restore of ClickHouse databases with support for various storage types.
...
- [Altinity/clickhouse-operator](https://github.com/Altinity/clickhouse-operator) - A Kubernetes operator for managing ClickHouse clusters, providing features like scaling, configuration management, and Prometheus integration.
...
- [ClickHouse/metabase-clickhouse-driver](https://github.com/ClickHouse/metabase-clickhouse-driver) - A ClickHouse driver for Metabase that enables seamless integration for data visualization and analysis.
...
- [PostHog/charts-clickhouse](https://github.com/PostHog/charts-clickhouse) - A Helm chart for deploying PostHog with ClickHouse on Kubernetes, though Kubernetes support has been sunsetted.
...
- [getdozer/dozer](https://github.com/getdozer/dozer) - Dozer is a high-performance real-time data movement tool that utilizes CDC to transfer data from various sources to multiple sinks, including Clickhouse.
...
- [ildus/clickhouse_fdw](https://github.com/ildus/clickhouse_fdw) - `clickhouse_fdw` is an open-source Foreign Data Wrapper for PostgreSQL that allows seamless integration with ClickHouse, enabling direct access to ClickHouse data from PostgreSQL.
...
- [jneo8/clickhouse-setup](https://github.com/jneo8/clickhouse-setup) - A tutorial for setting up ClickHouse servers and clusters using Docker.
...
- [red-soft-ru/clickhouse-rpm](https://github.com/red-soft-ru/clickhouse-rpm) - A build script for creating ClickHouse RPM packages on RHEL-based distributions.
...
- [Telegram](https://t.me/clickhouse_ru) - A Telegram channel for discussions and updates about ClickHouse.
